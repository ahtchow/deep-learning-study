...
return a}
var Eb={ia:"allow-forms",ja:"allow-modals",ka:"allow-orientation-lock",la:"allow-pointer-lock",ma:"allow-popups",na:"allow-popups-to-escape-sandbox",oa:"allow-presentation",pa:"allow-same-origin",qa:"allow-scripts",ra:"allow-top-navigation",sa:"allow-top-navigation-by-user-activation"},Gb=Ia(function(){return Fb()});
...
function b(m){for(var r=k,p=0;64>p;p+=4)r[p/4]=m[p]<<24|m[p+1]<<16|m[p+2]<<8|m[p+3];for(p=16;80>p;p++)m=r[p-3]^r[p-8]^r[p-14]^r[p-16],r[p]=(m<<1|m>>>31)&4294967295;m=e[0];var v=e[1],y=e[2],D=e[3],L=e[4];for(p=0;80>p;p++){if(40>p)if(20>p){var ea=D^v&(y^D);var Aa=1518500249}else ea=v^y^D,Aa=1859775393;else 60>p?(ea=v&y|D&(v|y),Aa=2400959708):(ea=v^y^D,Aa=3395469782);ea=((m<<5|m>>>27)&4294967295)+ea+L+Aa+r[p]&4294967295;L=D;D=y;y=(v<<30|v>>>2)&4294967295;v=m;m=ea}e[0]=e[0]+m&4294967295;e[1]=e[1]+v&4294967295;
e[2]=e[2]+y&4294967295;e[3]=e[3]+D&4294967295;e[4]=e[4]+L&4294967295}
...
function Nb(a){var b=Lb();b.update(a);return b.Z().toLowerCase()}
...
return function(e){d.next={N:e};d=d.next;b.port2.postMessage(0)}}return function(e){x.setTimeout(e,0)}}
...
return d};var Ec=window.yt&&window.yt.config_||window.ytcfg&&window.ytcfg.data_||{};C("yt.config_",Ec);function Fc(a){var b=arguments;1<b.length?Ec[b[0]]=b[1]:1===b.length&&Object.assign(Ec,b[0])}
...
;var Lc=0;C("ytDomDomGetNextId",z("ytDomDomGetNextId")||function(){return++Lc});var Mc={stopImmediatePropagation:1,stopPropagation:1,preventMouseEvent:1,preventManipulation:1,preventDefault:1,layerX:1,layerY:1,screenX:1,screenY:1,scale:1,rotation:1,webkitMovementX:1,webkitMovementY:1};
...
Nc.prototype.stopImmediatePropagation=function(){this.event&&(this.event.cancelBubble=!0,this.event.stopImmediatePropagation&&this.event.stopImmediatePropagation())};var G=z("ytEventsEventsListeners")||{};C("ytEventsEventsListeners",G);var Oc=z("ytEventsEventsCounter")||{count:0};C("ytEventsEventsCounter",Oc);
...
function fd(a,b){pc.L.apply(pc,arguments)}
...
gd.prototype.i=function(a){if(a.origin==T(this,"host")||a.origin==T(this,"host").replace(/^http:/,"https:")){try{var b=JSON.parse(a.data)}catch(c){return}this.h=!0;this.f||0!=a.origin.indexOf("https:")||(this.f=!0);if(a=id[b.id])a.B=!0,a.B&&(F(a.u,a.M,a),a.u.length=0),a.V(b)}};
...
V.g();var nd=z("ytPubsubPubsubInstance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.F;O.prototype.publish=O.prototype.L;O.prototype.clear=O.prototype.clear;C("ytPubsubPubsubInstance",nd);C("ytPubsubPubsubSubscribedKeys",z("ytPubsubPubsubSubscribedKeys")||{});C("ytPubsubPubsubTopicToKeys",z("ytPubsubPubsubTopicToKeys")||{});C("ytPubsubPubsubIsSynchronous",z("ytPubsubPubsubIsSynchronous")||{});var W=window,od=W.ytcsi&&W.ytcsi.now?W.ytcsi.now:W.performance&&W.performance.timing&&W.performance.now&&W.performance.timing.navigationStart?function(){return W.performance.timing.navigationStart+W.performance.now()}:function(){return(new Date).getTime()};var pd=kd("initial_gel_batch_timeout",1E3),qd=Math.pow(2,16)-1,rd=null,sd=0,td=void 0,ud=0,vd=0,wd=0,xd=!0,yd=z("ytLoggingTransportLogPayloadsQueue_")||{};C("ytLoggingTransportLogPayloadsQueue_",yd);var zd=z("ytLoggingTransportGELQueue_")||new Map;C("ytLoggingTransportGELQueue_",zd);var Ad=z("ytLoggingTransportTokensToCttTargetIds_")||{};C("ytLoggingTransportTokensToCttTargetIds_",Ad);
...
;var Jd=z("ytLoggingGelSequenceIdObj_")||{};C("ytLoggingGelSequenceIdObj_",Jd);function Kd(a){var b=Ld;a=void 0===a?z("yt.ads.biscotti.lastId_")||"":a;b=Object.assign(Md(b),Nd(b));b.ca_type="image";a&&(b.bid=a);return b}
...
function Xd(a,b){b.za&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=R("XSRF_FIELD_NAME",void 0),d=b.ha;d&&(d[c]&&delete d[c],a=Xc(a,d));return a}
function Yd(a,b){var c=R("XSRF_FIELD_NAME",void 0),d=R("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.o,k=R("XSRF_FIELD_NAME",void 0),g;b.headers&&(g=b.headers["Content-Type"]);b.ya||K(J(a)[3]||null)&&!b.withCredentials&&K(J(a)[3]||null)!=document.location.hostname||"POST"!=b.method||g&&"application/x-www-form-urlencoded"!=g||b.o&&b.o[k]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=Wc(e),Oa(e,f),e=b.U&&"JSON"==b.U?JSON.stringify(e):Bb(e));if(!(c=e)&&(c=f)){a:{for(var h in f){f=!1;break a}f=!0}c=!f}!Sd&&
...
function ge(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||R("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.ua||R("AUTHORIZATION"))||(a?b="Bearer "+z("gapi.auth.getToken")().ta:b=Ob([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=R("SESSION_INDEX",0),U("pageid_as_header_web")&&(d["X-Goog-PageId"]=R("DELEGATED_SESSION_ID")));return d}
...
ie.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.f)try{this.f.set(a,b,B()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(nc(b))}catch(f){return}else e=escape(b);b=this.g;tb.set(""+a,e,{O:c,path:"/",domain:void 0===b?"youtube.com":b,secure:!1})};
...
function Id(a,b,c,d){!R("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&Kc(new me("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady())throw b=new me("innertube xhrclient not ready",b,c,d),Jc(b),b.f=0,b;var e={headers:{"Content-Type":"application/json"},method:"POST",o:c,U:"JSON",C:function(){d.C()},
...
timeout:d.timeout,withCredentials:!0},f="",k=a.f.ea;k&&(f=k);k=a.f.fa||!1;var g=ge(k,f,d);Object.assign(e.headers,g);e.headers.Authorization&&!f&&(e.headers["x-origin"]=window.location.origin);var h=Xc(""+f+("/youtubei/"+a.f.innertubeApiVersion+"/"+b),{alt:"json",key:a.f.innertubeApiKey}),l;if(d.retry&&U("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=f&&(l=je(b,c,g,k))){var n=e.onSuccess,m=e.R;e.onSuccess=function(r,p){ke(l);n(r,p)};
c.R=function(r,p){ke(l);m(r,p)}}try{U("use_fetch_for_op_xhr")?Wd(h,e):(e.method="POST",e.o||(e.o={}),Zd(h,e))}catch(r){if("InvalidAccessError"==r.name)l&&(ke(l),l=0),Kc(Error("An extension is blocking network request."));
else throw r;}l&&md(function(){le(a)})}
;var oe=[{P:function(a){return"Cannot read property '"+a.key+"'"},
...
groups:["key"]}]}}];var pe=new Set,qe=0,re=void 0;function se(a,b,c,d){c+="."+a;a=String(JSON.stringify(b)).substr(0,500);d[c]=a;return c.length+a.length}
;function Y(a,b,c){this.m=this.f=this.g=null;this.l=wa(this);this.h=0;this.B=!1;this.u=[];this.i=null;this.W=c;this.Y={};c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"==a.tagName.toLowerCase(),b.host||(b.host=c?zb(a.src):"https://www.youtube.com"),this.g=new gd(b),c||(b=te(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.f=a,this.f.id||(this.f.id="widget"+wa(this.f)),ad[this.f.id]=this,window.postMessage){this.i=new O;ue(this);b=T(this.g,"events");for(var d in b)b.hasOwnProperty(d)&&
this.addEventListener(d,b[d]);for(var e in cd)ve(this,e)}}
...
if(!c)return this;this.i.subscribe(a,c);we(this,a);return this};
function ve(a,b){var c=b.split(".");if(2==c.length){var d=c[1];a.W==c[0]&&we(a,d)}}
...
q.G=function(){return{}};
function xe(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.B?a.M(b):a.u.push(b)}
q.D=function(a,b){if(!this.i.h){var c={target:this,data:b};this.i.L(a,c);fd(this.W+"."+a,c)}};
function te(a,b){for(var c=document.createElement("iframe"),d=b.attributes,e=0,f=d.length;e<f;e++){var k=d[e].value;null!=k&&""!=k&&"null"!=k&&c.setAttribute(d[e].name,k)}c.setAttribute("frameBorder",0);c.setAttribute("allowfullscreen",1);c.setAttribute("allow","accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture");c.setAttribute("title","YouTube "+T(a.g,"title"));(d=T(a.g,"width"))&&c.setAttribute("width",d);(d=T(a.g,"height"))&&c.setAttribute("height",d);var g=a.G();g.enablejsapi=
...
function ue(a){hd(a.g,a,a.l);a.h=Uc(A(a.T,a));Sc(a.f,"load",A(function(){window.clearInterval(this.h);this.h=Uc(A(this.T,this))},a))}
function we(a,b){a.Y[b]||(a.Y[b]=!0,xe(a,"addEventListener",[b]))}
q.M=function(a){a.id=this.l;a.channel="widget";a=nc(a);var b=this.g;var c=zb(this.f.src||"");b=0==c.indexOf("https:")?[c]:b.f?[c.replace("http:","https:")]:b.h?[c]:[c,c.replace("http:","https:")];if(this.f.contentWindow)for(c=0;c<b.length;c++)try{this.f.contentWindow.postMessage(a,b[c])}catch(L){if(L.name&&"SyntaxError"==L.name){if(!(L.message&&0<L.message.indexOf("target origin ''"))){var d=void 0,e=void 0,f=L;e=void 0===e?{}:e;e.name=R("INNERTUBE_CONTEXT_CLIENT_NAME",1);e.version=R("INNERTUBE_CONTEXT_CLIENT_VERSION",
void 0);var k=e||{};e="WARNING";e=void 0===e?"ERROR":e;d=void 0===d?!1:d;if(f){if(U("console_log_js_exceptions")){var g=f,h=[];h.push("Name: "+g.name);h.push("Message: "+g.message);g.hasOwnProperty("params")&&h.push("Error Params: "+JSON.stringify(g.params));h.push("File name: "+g.fileName);h.push("Stacktrace: "+g.stack);window.console.log(h.join("\n"),g)}if((window&&window.yterr||d)&&!(5<=qe)&&0!==f.f){var l=void 0,n=qb(f);d=n.message||"Unknown Error";g=n.name||"UnknownError";h=n.lineNumber||"Not available";
var m=n.fileName||"Not available";n=n.stack||f.g||"Not available";if(f.hasOwnProperty("args")&&f.args&&f.args.length){var r=0;for(l=0;l<f.args.length;l++){var p=f.args[l],v="params."+l;r+=v.length;if(p)if(Array.isArray(p))for(var y=k,D=0;D<p.length&&!(p[D]&&(r+=se(D,p[D],v,y),500<r));D++);else if("object"===typeof p)for(y in y=void 0,D=k,p){if(p[y]&&(r+=se(y,p[y],v,D),500<r))break}else k[v]=String(JSON.stringify(p)).substring(0,500),r+=k[v].length;else k[v]=String(JSON.stringify(p)).substring(0,500),
r+=k[v].length;if(500<=r)break}}else if(f.hasOwnProperty("params")&&f.params)if(p=f.params,"object"===typeof f.params)for(l in v=0,p){if(p[l]&&(r="params."+l,y=String(JSON.stringify(p[l])).substr(0,500),k[r]=y,v+=r.length+y.length,500<v))break}else k.params=String(JSON.stringify(p)).substr(0,500);k={message:d,name:g,lineNumber:h,fileName:m,stack:n,params:k};f=Number(f.columnNumber);isNaN(f)||(k.lineNumber=k.lineNumber+":"+f);f=k;void 0===re&&(re=Math.random()<kd("log_js_error_clusters"));if(!0===
re)a:for(g=u(oe),k=g.next();!k.done;k=g.next())if(k=k.value,k.K[f.name])for(h=u(k.K[f.name]),d=h.next();!d.done;d=h.next())if(m=d.value,d=f.message.match(m.regexp)){f.params["error.original"]=d[0];g=m.groups;h={};for(m=0;m<g.length;m++)h[g[m]]=d[m+1],f.params["error."+g[m]]=d[m+1];f.message=k.P(h);break a}window.yterr&&ua(window.yterr)&&window.yterr(f);if(!(pe.has(f.message)||0<=f.stack.indexOf("/YouTubeCenter.js")||0<=f.stack.indexOf("/mytube.js"))){if(U("kevlar_gel_error_routing")){k=void 0;g=e;
...
m.params)for(n=u(Object.keys(m)),l=n.next();!l.done;l=n.next())l=l.value,h.kvPairs.push({key:"client."+l,value:String(m[l])});h={errorMetadata:h,stackTrace:g,logMessage:d};k=void 0===k?{}:k;d=ne;R("ytLoggingEventsDefaultDisabled",!1)&&ne==ne&&(d=null);k=void 0===k?{}:k;g={};g.eventTimeMs=Math.round(k.timestamp||od());g.clientError=h;h=String;k.timestamp?m=-1:(m=z("_lact",window),null==m?m=-1:m=Math.max(B()-m,0));g.context={lastActivityMs:h(m)};U("log_sequence_info_on_gel_web")&&k.X&&(h=g.context,
m=k.X,Jd[m]=m in Jd?Jd[m]+1:0,h.sequence={index:Jd[m],groupKey:m},k.xa&&delete Jd[k.X]);k=k.wa;h="";k&&(h=k,m={},h.videoId?m.videoId=h.videoId:h.playlistId&&(m.playlistId=h.playlistId),Ad[k.token]=m,h=k.token);k=zd.get(h)||[];zd.set(h,k);k.push(g);d&&(td=new d);d=kd("web_logging_max_batch")||100;g=od();k.length>=d?Bd():10<=g-wd&&(Dd(),wd=g);Bd()}d=f;k=d.params||{};e={ha:{a:"logerror",t:"jserror",type:d.name,msg:d.message.substr(0,250),line:d.lineNumber,level:e,"client.name":k.name},o:{url:R("PAGE_NAME",
window.location.href),file:d.fileName},method:"POST"};k.version&&(e["client.version"]=k.version);if(e.o){d.stack&&(e.o.stack=d.stack);d=u(Object.keys(k));for(g=d.next();!g.done;g=d.next())g=g.value,e.o["client."+g]=k[g];if(k=R("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(d=u(Object.keys(k)),g=d.next();!g.done;g=d.next())g=g.value,e.o[g]=k[g];k=R("SERVER_NAME",void 0);d=R("SERVER_VERSION",void 0);k&&d&&(e.o["server.name"]=k,e.o["server.version"]=d)}Zd(R("ECATCHER_REPORT_HOST","")+"/error_204",
e);pe.add(f.message);qe++}}}}}else throw L;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function ye(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function ze(a){return 0===a.search("get")||0===a.search("is")}
...
q.V=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(va(a))for(var c in a)this.v[c]=a[c];break;case "infoDelivery":Ae(this,a);break;case "initialDelivery":window.clearInterval(this.h);this.playerInfo={};this.v={};Be(this,a.apiInterface);Ae(this,a);break;default:this.D(b,a)}};
function Ae(a,b){if(va(b))for(var c in b)a.playerInfo[c]=b[c]}
function Be(a,b){F(b,function(c){this[c]||("getCurrentTime"==c?this[c]=function(){var d=this.playerInfo.currentTime;if(1==this.playerInfo.playerState){var e=(B()/1E3-this.playerInfo.currentTimeLastUpdated_)*this.playerInfo.playbackRate;0<e&&(d+=Math.min(e,1))}return d}:ye(c)?this[c]=function(){this.playerInfo={};
this.v={};xe(this,c,arguments);return this}:ze(c)?this[c]=function(){var d=0;
0===c.search("get")?d=3:0===c.search("is")&&(d=2);return this.playerInfo[c.charAt(d).toLowerCase()+c.substr(d+1)]}:this[c]=function(){xe(this,c,arguments);
return this})},a)}
...
function Ce(a){if("iframe"!=a.tagName.toLowerCase()){var b=S(a,"videoid");b&&(b={videoId:b,width:S(a,"width"),height:S(a,"height")},new Z(a,b))}}
;function De(a,b){var c={title:"Thumbnail",videoId:"",width:120,height:68};if(b)for(var d in b)c[d]=b[d];Y.call(this,a,c,"thumbnail")}
oa(De,Y);De.prototype.H=function(){return"/embed/"+T(this.g,"videoId")};
De.prototype.G=function(){return{player:0,thumb_width:T(this.g,"thumbWidth"),thumb_height:T(this.g,"thumbHeight"),thumb_align:T(this.g,"thumbAlign")}};
De.prototype.D=function(a,b){Y.prototype.D.call(this,a,b?b.info:void 0)};
function Ee(a){if("iframe"!=a.tagName.toLowerCase()){var b=S(a,"videoid");if(b){b={videoId:b,events:{},width:S(a,"width"),height:S(a,"height"),thumbWidth:S(a,"thumb-width"),thumbHeight:S(a,"thumb-height"),thumbAlign:S(a,"thumb-align")};var c=S(a,"onclick");c&&(b.events.onClick=c);new De(a,b)}}}
...
C("YT.scan",dd);C("YT.subscribe",function(a,b,c){pc.subscribe(a,b,c);cd[a]=!0;for(var d in ad)ve(ad[d],a)});
C("YT.unsubscribe",function(a,b,c){oc(a,b,c)});
C("YT.Player",Z);C("YT.Thumbnail",De);Y.prototype.destroy=Y.prototype.destroy;Y.prototype.setSize=Y.prototype.setSize;Y.prototype.getIframe=Y.prototype.ga;Y.prototype.addEventListener=Y.prototype.addEventListener;Z.prototype.getVideoEmbedCode=Z.prototype.getVideoEmbedCode;Z.prototype.getOptions=Z.prototype.getOptions;Z.prototype.getOption=Z.prototype.getOption;bd.push(function(a){a=ed("player",a);F(a,Ce)});
bd.push(function(){var a=ed("thumbnail");F(a,Ee)});
"undefined"!=typeof YTConfig&&YTConfig.parsetags&&"onload"!=YTConfig.parsetags||dd();var Fe=z("onYTReady");Fe&&Fe();var Ge=z("onYouTubeIframeAPIReady");Ge&&Ge();var He=z("onYouTubePlayerAPIReady");He&&He();}).call(this);
